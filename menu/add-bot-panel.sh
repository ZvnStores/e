...
# Getting
#satusbot
bot_zhee=$(systemctl status kyt | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
# STATUS SERVICE  BOT 
if [[ $bot_zhee == "running" ]]; then 
...
echo -e   ""
case $opt in
01 | 1) clear ; wget https://raw.githubusercontent.com/myzid/v3/main/zhee.sh && chmod +x zhee.sh && ./zhee.sh ;;
